package br.com.hipertrofia.dao;
...
import br.com.hipertrofia.factory.FabricaConexao;
...
public class hipertrofiaDAO {
		...
		try {
			...
			//Enquanto existir dados no banco de dados, faça
			 while(metodoDePagamentos.next()){
				 Cartao cartoes= new Cartao(0,0,0,0);
	...
	public List<Pedido> getOrdens(){	
		String comandoSQL = "SELECT*FROM pedido;" ;
					...
					//Enquanto existir dados no banco de dados, faça
					 while(pedido.next()){
						...
						//recupera o número do cartão do banco e atribui ele ao objeto
						 ...
						 ordem.setReferenciaP(pedido.getString("nomeProduto"));
						 //Recupera o tamanho do banco e atribui ele ao objeto
						 ordem.setTamanhoP(pedido.getString("tamanhoP"));
						//Recupera o tamanho do banco e atribui ele ao objeto
						 ordem.setPrecoP(pedido.getFloat("precoP"));
						//Recupera o tamanho do banco e atribui ele ao objeto
						 ordem.setMetodoPagamento(pedido.getInt("formaPagamento"));
